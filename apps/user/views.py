...
from django.views import View  #类视图使用
...
from itsdangerous import SignatureExpired  #加密过期异常
from django.conf import settings
...
class RegisterView(View):
    ...
    def post(self,request):
        ...
        # 发送激活邮件，包含激活链接：http://127.0.0.1:8000/user/active/1(user.id)
        #激活链接里需要包含用户身份信息，并且要把身份信息进行加密
